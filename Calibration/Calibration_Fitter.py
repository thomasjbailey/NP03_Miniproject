...
plt.errorbar(time_list_06, [i.n for i in a_list_06], [i.s for i in a_list_06], fmt='x', color='C0', linestyle='', label='Day 1')
plt.errorbar(time_list_12, [i.n for i in a_list_12], [i.s for i in a_list_12], fmt='+', color='C1', linestyle='', label='Day 2')
plt.errorbar(time_list_13, [i.n for i in a_list_13], [i.s for i in a_list_13], fmt='o', color='C2', linestyle='', label='Day 3')
...
plt.errorbar(time_list_06, [i.n for i in b_list_06], [i.s for i in b_list_06], fmt='x', color='C0', linestyle='', label='Day 1')
plt.errorbar(time_list_12, [i.n for i in b_list_12], [i.s for i in b_list_12], fmt='+', color='C1', linestyle='', label='Day 2')
plt.errorbar(time_list_13, [i.n for i in b_list_13], [i.s for i in b_list_13], fmt='o', color='C2', linestyle='', label='Day 3')
